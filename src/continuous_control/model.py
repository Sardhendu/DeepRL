...
class DDPGActor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed=2, fc1_units=512, fc2_units=256):
...
class DDPGCritic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed=2, fcs1_units=512, fc2_units=512):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
